...
class Error(Exception):
    '''Base error class for NI-Sync Driver'''
...
class DriverTooOldError(Error):
    '''An error due to using this module with an older version of the NI-Sync driver runtime.'''

    def __init__(self):
        super(DriverTooOldError, self).__init__('A function was not found in the NI-Sync runtime. Please visit http://www.ni.com/downloads/drivers/ to download a newer version and install it.')


class DriverTooNewError(Error):
    '''An error due to the NI-Sync driver runtime being too new for this module.'''

    def __init__(self):
        super(DriverTooNewError, self).__init__('The NI-Sync runtime returned an unexpected value. This can occur if it is too new for the nisync Python module. Upgrade the nidigital Python module.')
